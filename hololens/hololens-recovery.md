...
- Från huvudmenyn i HoloLens-enhetens användargränssnitt.
...
4. Anslut enheten till värddatorn och öppna sedan Enhetshanteraren. (För Windows 10 trycker du på Windows-tangenten och sedan **på X** och väljer **sedan Enhetshanteraren**.)  Kontrollera att enheten räknas upp korrekt enligt *Microsoft HoloLens* som visas i följande bild:
...
4. Anslut enheten till värddatorn.

5. Öppna Enhetshanteraren (för Windows 10 du **på Windows-tangenten** och sedan på **X-tangenten** och välj sedan **Enhetshanteraren**). Kontrollera att enheten räknas upp korrekt enligt *Microsoft HoloLens* som visas i följande bild:
...
1. När HoloLens-enheten körs ansluter du den till Windows 10 dator där du tidigare öppnade appen Advanced Recovery Companion.
...
3. Välj HoloLens 2-enheten i appen Advanced Recovery Companion och följ instruktionerna för att slutföra omstrecket.
...
4. Anslut enheten till värddatorn och öppna Enhetshanteraren. (För Windows 10 du **på Windows-tangenten** och sedan på **X-tangenten** och väljer sedan **Enhetshanteraren**.) Kontrollera att enheten räknas upp korrekt enligt Microsoft HoloLens som visas i följande bild:
...
6. Välj HoloLens 2-enheten i appen Advanced Recovery Companion och följ sedan anvisningarna för att slutföra omstrecket.
...
Om IT-miljön förhindrar användning av Windows Store-appen eller begränsar åtkomsten till butiken, kan IT-administratören göra den här appen tillgänglig via en "offline"-distributionssökväg.
 ...
 >[!NOTE]
 > - IT-administratörer kan också distribuera den här appen via System Center Konfigurationshanteraren (SCCM) eller Intune.
