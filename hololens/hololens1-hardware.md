...
| **Holographic-upplösning** | 2 HD 16:9-motorer som producerar 2,3 miljoner totala ljuspunkter |
...
![HoloLens har sensorer för att förstå dess miljö- och användaråtgärder.](images/sensor-bar-400px.jpg)
...
### <a name="input-output-and-connectivity"></a>Indata, utdata och anslutning
...
- Intel 32-bitars arkitektur med stöd för TPM 2.0
- Anpassad Microsoft Holographic Processing Unit (HPU 1.0)
...
Använd följande för att förstå användaråtgärder:

- Blickspårning
- Gestinmatning
- Röststöd

Använd följande för att förstå miljön:
...
HoloLens har testats och visat sig uppfylla de grundläggande effektskyddskraven för ANSI Z87.1, CSA Z94.3 och EN 166.
