...
* **Öka skärmens ljusstyrka.** Hologram bäst när skärmen är på den bästa nivån. När du använder HoloLens är ljusstyrkan på vänster sida av visor-programmet nära ditttempel.
...
* **[Köra ögonkalibrering.](hololens-calibration.md#calibrating-your-hololens-2)** Skärmen använder ditt interpupillary distance (IPD) och blick för att optimera bilder på skärmen. Om du inte kör ögonbehandling kan bildkvaliteten bli sämre. Om du vill köra kalibrering av ögonen **går du Inställningar**  >  **Kalibrering av system** för  >    >  **kalibrering av ögon kalibrering**.
* **Kör kalibrering av visningsfärg**. På [Windows Holographic version 21H1](hololens-release-notes.md#windows-holographic-version-21h1) och senare kan  du välja en alternativ färgprofil för din HoloLens 2-skärm. Detta kan hjälpa färger att se mer exakta ut, särskilt på lägre nivåer av skärmens ljusstyrka. Du hittar kalibrering av bildskärmsfärg **i Inställningar** app på sidan System **> Kalibrering.**
...
- På Inställningar visas statussträngen som anger när färgprofilen senast ändrades tills du läser in sidan på Inställningar 
    - **Lösning:** Välj Inställningar en annan sida och välj sedan sidan Kalibrering igen.
- Om din HoloLens 2 för strömsparläge medan visningsfärgen körs återupptas den senare till mixed reality-startsidan och din skärms ljusstyrkanivå är fortfarande nedtonad.
...
Ibland visar HoloLens 2 olika mönster längst ned till vänster och höger på skärmen. Exemplen visas nedan (animerade GIF-filer). Det här mönstret är en del av normal drift av din HoloLens 2-enhet för att kalibrera skärmen för optimal upplevelse.
...
* **Kameraexponeringstid.** Kamerans exponeringstid måste vara en exakt multipel av 1/120 sekund. Bildfrekvens HoloLens 120 Hz. På grund av hur HoloLens 2 ritar bilder räcker det inte heller att skapa en enda bildruta för att matcha en människas visuella upplevelse. Om enheten rör sig alls – till och med mikroflyttar – projektiverar systemet om bilden på skärmen för att stabilisera hologrammen. Att samla in flera bildrutor samtidigt som HoloLens från att flyttas kräver vanligtvis en labbinstallation.
* **Kamerastorlek.** Kamerans storlek måste vara minst 3 mm för att kunna ta en korrekt bild. Mobiltelefonkameror med små barn integrerar ljus från ett mindre område än det mänskliga ögat. Enheten tillämpar färgkorrigering för mönster som observerats av större ljus. Med små dräkter blir enhetlighetsmönstren bättre och förblir synliga trots att systemet har tillämpat färgkorrigeringar.
...
* **Kameraposition.** Kameror som uppfyller kraven för att visa HoloLens 2-skärmen är större och det är svårt att placera kameran tillräckligt nära HoloLens 2-skärmen för att se den färg korrigerade bilden. Om kameran är på fel plats kan färgkorrigeringen ha en negativ inverkan på insamlingen av HoloLens 2-skärmen.
* **Bildkorrigering.** Vanliga digitalkameror och smartphonekameror använder en TRC-kurva (Tone Reproduce Curve) som ökar kontrasten och färgen för att ge ett bättre resultat. När den här HoloLens 2-skärmen används förstärker den här tonkurvan icke-uniformiteter.
...
### <a name="what-does-eye-calibration-do-to-display-image-quality"></a>Vad gör ögonbehandling för att visa bildkvalitet?
...
### <a name="what-are-the-display-differences-between-hololens-1st-gen-and-hololens-2"></a>Vilka är visningsskillnaderna mellan HoloLens (första generationen) och HoloLens 2?

Bland de viktigaste begärandena som kunder gav Microsoft efter att ha HoloLens 1 var (1) ökade visningsområdet och (2) ökade ljusstyrkan. Teknikutvecklingen gjorde det möjligt för Microsoft att skapa vågguider som dubblerat visningsområdet och producerar ljusprojektorer med en bildskärm som är upp till tre gånger ljusare. Maskinvaran anger baslinjen för en trea kompromisser för visningsavbildningens kvalitet: (1) visningsfält, (2) ljusstyrka och (3) färgunialitet. Fortsatt teknikutveckling möjliggör förbättringar inom alla områden utan att offra ett annat område. Under tiden anger den befintliga tekniken de gränser som är tillgängliga för dessa kompromisser.

### <a name="what-improvements-are-coming-that-will-improve-hololens-2-image-quality"></a>Vilka förbättringar kommer att förbättra bildkvaliteten HoloLens 2?
...
Användarna får bästa möjliga upplevelse när de undviker vita bakgrunder. Mörkt läge är en designprincip som används av appar för att använda svarta eller mörkfärgade bakgrunder. Systeminställningarna har som standard mörkt läge och kan justeras genom att gå **till Inställningar**  >  **System**  >  **Color**.

Utvecklare rekommenderas att följa designvägledningen för mörkt läge:

* [Designriktlinjer för utvecklare för HoloLens visas](/windows/mixed-reality/designing-content-for-holographic-display#design-guidelines)
...
Använd mikrofiber för att rensa visorn. För att rensa visor-programmet använder du 70 % isopropyl för att enkelt prata en visor och sedan rensa visorn. Läs den fullständiga vägledningen i [vanliga frågor HoloLens 2 rensning.](hololens2-maintenance.md)
