...
Så här anger du detta via ett etableringspaket:
...
HoloLens-enheter Windows 10 enheter har olika val av sidor i appen Inställningar. På den här sidan hittar du bara de inställningar som finns på HoloLens.
...
| Ljud > appvolym och enhetsinställning <sup>2</sup>           | `ms-settings:apps-volume`<br>|
...
- <sup>1</sup> – För versioner före Windows Holographic version 21H1 tar inte följande  två URI:er dig till sidorna Avancerade alternativ **eller** Alternativ. De blockerar eller visar bara huvudsidan Windows Update sidan.
