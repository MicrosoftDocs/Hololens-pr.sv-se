...
- Både AAD- och Icke-ADD-konfigurationer stöder besökarkonton som automatiskt är aktiverade för helskärmsläge.
...
- Från och [Windows Holographic version 21H1](hololens-release-notes.md#windows-holographic-version-21h1)söker helskärmsläge efter global tilldelad åtkomst innan en tom Start-meny visas. Helskärmsupplevelsen kommer att gå tillbaka till en global kioskkonfiguration (om sådan finns) om det uppstår fel i helskärmsläget för AAD-grupper.
