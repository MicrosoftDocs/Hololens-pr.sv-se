...
Att komma runt HoloLens är ungefär som att använda din smarttelefon. Du kan använda händerna för att röra och manipulera holografiska fönster, menyer och knappar.  
...
![Bild som visar HoloLens-handspårningsramen](./images/hololens-2-gesture-frame.png)
...
När det inte finns några hologram  nära dina händer döljs pekmarkören automatiskt och handbilder visas från **händernas** röta. Med handbilder kan du interagera med hologram från ett avstånd.
...
> - Om din hand är lite utanför ramens sida kan du fortfarande visa Start-menyn genom att trycka på den inre handleden, även om du inte ser ikonen.
...
> 1. Ögonen måste kalibreras på enheten så att ögonspårningen fungerar korrekt. Om du inte ser punkter runt omloppsbana runt Start-ikonen när du tittar på den, kalibreras inte ögonen [på](https://docs.microsoft.com/hololens/hololens-calibration#calibrating-your-hololens-2) enheten.
...
Du hittar dina installerade appar [](holographic-home.md) i Start-menyn du hittar ytterligare appar för HoloLens i [Microsoft Store](holographic-store-apps.md).

Precis som Windows-datorer alltid startar sin upplevelse på skrivbordet, börjar HoloLens alltid i **mixed reality-hemmet när** det är aktiverat.  Med hjälp Start-menyn kan du öppna och placera appfönster, appstartare och 3D-innehåll i Mixed Reality-startsidan. HoloLens kommer att ihågta deras placering i ditt fysiska utrymme.

Öppna **Start-menyn** och välj sedan **panelen Inställningar.** Ett appfönster öppnas framför dig.

Inställningar är ett exempel på en HoloLens-app som använder ett **2D-appfönster.**  Det liknar ett Windows-program på datorn.

Nu kan du öppna **Start-menyn** igen och välja **appanelen Tips.** En **3D-appstartare** för appen visas framför dig. För att öppna appen måste du välja **uppspelningsknappen** i startprogrammet.
...
Vissa kunder tycker att det går snabbare att "skriva" på virtuella tangentbord genom att svepa formen på ordet som de tänker skriva. Nu med [Windows Holographic, version 21H1,](hololens-release-notes.md#windows-holographic-version-21h1)kan du svepa ett ord i taget genom att skicka fingertipset genom det holografiska tangentbordets plan, svepa formen på ordet och sedan dra upp fingertipset från tangentbordet. Du kan svepa upp uppföljningsord utan att behöva trycka på blanksteget genom att ta bort ditt finger från tangentbordet mellan ord. Du vet att funktionen fungerar om du ser en svepspår efter ditt fingerförflyttning på tangentbordet.
...
- [Dela din HoloLens med andra](hololens-multiple-users.md)

> [!TIP]
> Prova [designing holograms-appen.](https://www.microsoft.com/p/designing-holograms/9nxwnjklrzwd?rtc=1&activetab=pivot:overviewtab)