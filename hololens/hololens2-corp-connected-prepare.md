---
title: Distributionsguide – Företagsansluten HoloLens 2 med Dynamics 365-guider – Förbereda
...
Om MDM-systemen redan har konfigurerats för certifikat kan du gå till Förbereda certifikat och nätverksprofiler för [HoloLens 2](/hololens/hololens-certificates-network) för att börja distribuera certifikat och profiler för HoloLens 2 enheter.
...
Om nätverket inte redan har stöd för SCEP, eller om du är osäker på om nätverket är korrekt konfigurerat för SCEP med Intune, kan du gå till Konfigurera infrastruktur för att stödja SCEP med [Intune.](/mem/intune/protect/certificates-scep-configure)
...
## <a name="pkcs"></a>PKCS
Intune stöder också användning av PKCS-certifikat (privata och offentliga nyckelpar). Mer [information finns i Använda certifikat för privata och offentliga Microsoft Intune](/mem/intune/protect/certificates-pfx-configure) i en Microsoft Intune nyckel.
...
För dig som inte har en egen LOB tillhandahåller vi en exempelapp för att testa det här distributionsflödet. Den här appen kommer att [vara appen MRTK-exempel](https://aka.ms/HoloLensDocs-Sample-MRTK-Examples-App) och har redan förbyggts och paketerats för att testa konceptbevis.
