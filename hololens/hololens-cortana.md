...
> [!NOTE]
> Tal stöds endast på [vissa språk.](hololens2-language-support.md) Talspråket baseras på det Windows visningsspråket, inte tangentbordsspråket.  
>  
> Du kan kontrollera Windows visningsspråk genom att **välja Inställningar** tid  >  **och**  >  **språkspråk.**

## <a name="built-in-voice-commands"></a>Inbyggda röstkommandon

Kom runt HoloLens med dessa grundläggande kommandon. För att kunna använda dessa måste du aktivera Tal under den första körningen av enheten eller i **Inställningar**  >    >  **Sekretesstal**. Du kan alltid kontrollera om tal är aktiverat genom att titta på statusen överst i Start-menyn. För bästa taligenkänningsresultat använder HoloLens 2 Microsofts molnbaserade tjänster. Du kan dock använda Inställningar inaktivera den här funktionen. Det gör du genom att Inställningar av Taligenkänning **online.** När du har ändrat den här inställningen HoloLens 2 endast röstdata lokalt för att identifiera kommandon och diktering, och Cortana kommer inte att vara tillgänglig.
...
> [!NOTE]
> Hand rays stöds inte på HoloLens (första gen).
...
| "Stoppa inspelning" | Stoppar den aktuella videoinspelningen med mixad verklighet om en sådan pågår. |
...
Ibland kan det vara bra att stava ut saker som e-postadresser. Om du till exempel vill example@outlook.com diktera skulle du säga "E X A M P L E at outlook dot com".
...
- Gå till Start.
- Ta en bild.
- Börja spela in. (Börjar spela in en video.)
...
### <a name="turn-cortana-off"></a>Inaktivera Cortana av
