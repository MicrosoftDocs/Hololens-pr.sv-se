...
Från och med Windows Holographic version 2004 stöder HoloLens 2 Windows självdirebuerande autopilotläge med Microsoft Intune (MDM [från](/mem/autopilot/self-deploying) tredje part stöds inte). Den här konfigurationen minskar omkostnaderna för inventeringshantering, kostnaden för förberedelse av praktiska enheter och supportsamtal från anställda under installationen. Läs mer i [Windows Autopilot.](/mem/autopilot/windows-autopilot)
...
#### <a name="review-the-following-sections-of-the-windows-autopilot-requirements-article"></a>Läs följande avsnitt i artikeln om Windows Autopilot:
...
Vilka åtgärder krävs för att lösa det här felet?
...
Starta om enheten och försök igen. Mer information finns i [Kända problem och begränsningar.](hololens2-autopilot.md#known-issues-and-limitations)
