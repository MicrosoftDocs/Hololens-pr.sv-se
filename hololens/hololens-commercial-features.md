...
description: Lär dig mer Microsoft HoloLens kommersiella funktioner för företag för att hantera HoloLens enheter.
author: qianw211
ms.author: v-qianwen
ms.date: 9/1/2021
ms.custom:
...
## <a name="why-hololens"></a>Varför HoloLens?

Tack vare HoloLens 2 Mixed Reality program kan nu anställda samarbeta utan gränser, agera med precision och öka produktiviteten.

Samarbeta utan gränser och agera med precision för att öka medarbetarnas produktivitet med program med mixad verklighet HoloLens 2. Håll dig i fokus, handsfree längre och mer bekväm med inbyggda röstkommandon, ögonspårning och världsankare för kontinuerligt fokus på att utföra uppgifter på ett säkert sätt utan fel. Anslut med fjärranslutna kollegor i realtid och arbeta tillsammans på en omfattande holografisk arbetsyta som överläggs i din fysiska miljö för att snabbt lösa problem vid tidpunkten för arbetet. Realisera avkastning på investeringen (ROI) direkt från grunden med ett robust ekosystem med program som stöds med säkerhet, tillförlitlighet och skalbarhet hos Microsoft.  

Vi hoppas att den här artikeln inspirerar dig att tänka på alla sätt på vilka mixed reality (MR) kommer att vara till nytta för ditt företag.
...
| Handspårning | Röra, förstå och flytta hologram på ett sätt som känns naturligt. HoloLens 2 anpassas efter dina händer för en nyfunnen nöjdhet i dina interaktioner. |
...
| Röstaktiverad | Med inbyggda röstkommandon kan du snabbt navigera och HoloLens 2 när dina händer är upptagna med en uppgift. |
| Ergonomisk | HoloLens 2 är förenklat (3,28 kg) som innehåller ett system för uppringning som stöder utökad användning. |
...
| Windows Autopilot | Konfigurera och förkonfigurera tjänster för HoloLens 2 så att de är redo att använda direkt via distribuerade arbeten. |
| Os-uppdateringar | Håll dig säker med månatliga underhållsuppdateringar och dra nytta av nya produktivitets- och hanterbarhetsfunktioner i två års versioner. |
...
## <a name="how-hololens-2-is-transforming-industries"></a>Hur HoloLens 2 omvandlar branscher
...
:::row:::
    ...
    :::column-end:::
    :::column span="2":::
        ### <a name="eatons-vehicle-group-uses-dynamics-365-mixed-reality-to-drive-savings-efficiencies"></a>[I Vehicle Group i Maton används Mixad verklighet i Dynamics 365 för att spara pengar och öka effektiviteten.](https://customers.microsoft.com/en-us/story/1406696349549504197-eaton-vehicle-group-dynamics-365-mixed-reality)
        "Tänk dig att vi talar olika språk när du beskriver ett problem. När du förklarar det kanske någon på den andra sidan inte förstår exakt vad som händer, men när du visar det i realtid med HoloLens förstår folk." <br> –Hanteraren m. Tar: Plant Manager på Eaton.
    :::column-end:::
:::row-end:::
...
:::row:::
    ...
    :::column-end:::
    :::column span="2":::
        ### <a name="zf-builds-agile-facility-at-gray-court-with-microsoft-365-improves-operational-equipment-efficiency"></a>[ZF bygger en flexibel anläggning på Gray Court med Microsoft 365, vilket förbättrar effektiviteten i driftutrustningen.](https://customers.microsoft.com/en-us/story/1341470537472393895-zfgroup-gray-court-chapter-automotive-microsoft365)
        För ZF-Microsoft 365 hjälper de anställda att dela kunskap, felsöka och kommunicera i realtid. 
    :::column-end:::
:::row-end:::
...
:::row:::
    ...
    :::column-end:::
    :::column span="2":::
        ### <a name="tokyu-construction-improves-engineering-precision-and-increases-productivity-with-azure-remote-rendering-on-hololens-2"></a>[Tokyu Construction förbättrar den tekniska precisionen och ökar produktiviteten med Azure Remote Rendering på HoloLens 2.](https://customers.microsoft.com/en-us/story/1333933369626897988-tokyu-construction-manufacturing-azure-holo-lens-2)
        Såvida du inte är en tränad arkitekturtekniker kan det vara svårt att titta på en 2D-skiss och visualisera hur en byggnad faktiskt kommer att se ut i 3D. 
    :::column-end:::
:::row-end:::
...
:::row:::
    ...
    :::column-end:::
    :::column span="2":::
        ### <a name="mda-takes-mixed-reality-into-orbit-with-hololens-2"></a>[MDA för in mixad verklighet i omloppsbana med HoloLens 2.](https://customers.microsoft.com/en-us/story/1377057233739728271-mda-manufacturing-hololens-canada)
        MDA använder integrerande upplevelser med mixad verklighet för att hjälpa tekniker att visualisera design, påskynda diagnostikproblem och träna astronauter och markkontrollers.
    :::column-end:::
:::row-end:::
<br>
...
| Kryptera användardata | [**Datasäkerhet**](security-encryption-data-protection.md) | BitLocker-datakryptering är aktiverat på HoloLens 2 för att ge samma säkerhetsnivå som andra Windows enhet. | 
