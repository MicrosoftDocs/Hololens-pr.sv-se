...
HoloLens 2-enheter [Windows Holographic version 20H2](hololens-release-notes.md#windows-holographic-version-20h2) eller senare har nyare funktioner för att förenkla den här processen, vilket gör den automatisk. Läs följande avsnitt:

- [Automatisk start av etablering från USB](hololens-provisioning.md#auto-launch-provisioning-from-usb)
- [Bekräfta etableringspaket automatiskt i OOBE](hololens-provisioning.md#auto-confirm-provisioning-packages-in-oobe)
...
5. Tryck en kort stund och släpp **knapparna Volym ned** **och** Ström samtidigt på sidan **Första interagerande** ögonblick i OOBE.
