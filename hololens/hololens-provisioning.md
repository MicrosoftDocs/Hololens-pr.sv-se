...
- Aktivera utvecklarläge
- Konfigurera helskärmsläge genom att följa [detaljerade anvisningar](hololens-kiosk.md#use-a-provisioning-package-to-set-up-a-single-app-or-multi-app-kiosk)).
...
1. På startsidan Windows Configuration Designer väljer du **Avancerad etablering.**
...
1. Använd USB-kabeln för att ansluta enheten till en dator (eller USB-enhet för HoloLens 2 som nämns ovan) och starta sedan enheten. Fortsätt inte förbi sidan **First interactable moment** i OOBE.   
...
5. Tryck kort och släpp knapparna **Volym ned** och **Ström** samtidigt samtidigt på sidan **Första interagerande ögonblick** i OOBE.
...
När etableringens huvudskärm visas räknar OOBE ned 10 sekunder innan alla etableringspaket börjar tillämpas automatiskt. Användare kan fortfarande bekräfta eller avbryta inom dessa 10 sekunder efter att ha verifierat de paket som de förväntade sig.
...
> [!NOTE]
> De här stegen gäller för HoloLens 2 HoloLens (första generationens) enheter på Windows Holographic, version 1809 och senare.
