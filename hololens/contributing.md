...
ms.locfileid: "123188992"
---
# <a name="contributing-to-the-hololens-documentation"></a>Bidra till HoloLens dokumentation
...
>[!IMPORTANT]
>Du kan bara ladda upp bilder till din förked lagringsplatsen innan du sammanfogar. Så om du planerar att lägga till bilder i en artikel måste du använda [Visual Studio Code](#using-visual-studio-code) för att först lägga till bilderna i din förk"images"-mapp eller kontrollera att du har gjort följande i en webbläsare:
>
