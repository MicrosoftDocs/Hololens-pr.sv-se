...
Azure och Intune använder med det tillägget användare och grupper för att tilldela konfigurationer och licenser. För att verifiera det här distributionsflödet och kontrollera att du kan skapa och använda en guide behöver&#39;behöver ett användarkonto.
...
## <a name="corporate-wi-fi-connectivity"></a>Anslutning Wi-Fi företagsanslutningar
...
3. Skapa en profil för företagets Wi-Fi nätverk (se [Wi-Fi-inställningar för Windows 10 enheter och senare enheter).](/intune/wi-fi-settings-windows) I din Wi-Fi profil kan du välja att använda proxyinställningarna i din organisation.
...
> [!NOTE]
> Systemkraven för HoloLens baseras på arkitekturen i appbygget. HoloLens 2-enheter använder ARM-arkitektur. När du skapar dina appar Visual Studio bör du se till att du har valt rätt arkitektur för enheten och att du har tagit med eventuella beroenden som behövs.
