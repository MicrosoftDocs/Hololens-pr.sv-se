...
- **Visor .** Innehåller de HoloLens sensorerna och visas. Du kan rotera upp visor-programmet medan du använder HoloLens.
...
- **Ljusstyrka-knappar**. När du använder HoloLens är knapparna för ljusstyrka på vänster sida av visor-programmet nära ditttempel.
...
- **[Overhead overhead overhead](https://www.microsoft.com/p/microsoft-hololens-2-overhead-strap/8wxl8wmk1f7z)**. När du använder HoloLens medan du flyttar kan du använda overhead-apparat för att hålla enheten på plats. När du använder HoloLens under längre perioder kan omkostnaderna göra enheten mer bekväm att använda.
...
> [!NOTE]
> Ta inte upp några av de sensorer som visas i bilden. Huvudspårningskamerorna har ett mycket brett FOV, och inget bör finnas runt dem, förutom att de inte täcker dem.
