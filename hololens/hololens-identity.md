...
| --- | --- | --- |
| [Azure Active Directory](/azure/active-directory/)<sup>1</sup>  | 64 | <ul><li>Azure-provider för webb autentiseringsuppgifter</li><li>Azure Authenticator App</li><li>Biometrik (Iris) &ndash; HoloLens 2 endast<sup>2</sup> </li><li>&ndash;PIN-kod HoloLens (första generationen), krävs för HoloLens 2</li><li>Lösenord</li></ul> |
...
Det vanligaste sättet att konfigurera en ny användare är HoloLens oobe(out-of-box experience). Under installationen HoloLens en användare att logga in med det konto som han eller hon vill använda på enheten. Det här kontot kan vara en Microsoft-konto eller ett företagskonto som har konfigurerats i Azure. Se Konfigurera din [HoloLens (första generationen) eller](hololens1-start.md) [HoloLens 2.](hololens2-start.md)
...
Windows Hello for Business (som stöder användning av en PIN-kod för att logga in) stöds för HoloLens (första generationen). Så här tillåter Windows Hello inloggning med PIN-kod för företag HoloLens:
