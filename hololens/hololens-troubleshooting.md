...
> [!NOTE]
> Det här är **ett känt** problem som åtgärdas i Windows Insider-versionen, version 20348.1403.

I tidigare versioner av Windows Holographic skulle resultatet bli en HTTP-felsida när du försöker ladda ned en låst fil. I Windows Holographic version 21H1-uppdateringen resulterar försök att ladda ned en låst fil i att inget visas – filen laddas inte ned och det uppstår inget fel.

[Tillbaka till listan](#list)

## <a name="device-portal-file-uploaddownload-times-out"></a>Enhetsportalen-filuppladdning/nedladdningstidsuppladdning
> [!NOTE]
> Det här är **ett känt** problem som åtgärdas i Windows Insider-versionen, version 20348.1403. Om du tidigare har inaktiverat SSL-anslutning som en del av lösningen rekommenderar vi starkt att du återaktivera den.


Vissa kunder har upptäckt att åtgärden kanske låser sig när de försöker ladda upp eller ladda ned filer och sedan tar slut eller aldrig slutförs. Detta är separat[](#downloading-locked-files-doesnt-error) från det kända problemet "fillås" – detta påverkar versioner av Windows Holographic, versionerna 2004, 20H2 och 21H1 på marknaden. Problemet har orsakats av en bugg i Enhetsportalen hantering av vissa begäranden och används mest konsekvent när https används, vilket är standardinställningen. 
