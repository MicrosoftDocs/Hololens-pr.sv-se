...
- [**Åtgärdat** – Remote Assist-video låser sig efter 20 minuter](#remote-assist-video-freezes-after-20-minutes)
...
- [**Åtgärdat** – Enhetsportalen för filuppladdning/nedladdningstidsuppladdning](#device-portal-file-uploaddownload-times-out)
...
Om du använder OneDrive For Business med ditt Azure AD-konto kan det ha uppstått ett fel när du loggar in i inkorgen OneDrive appen. Att inte kunna logga in på OneDrive påverkar inte automatiska uppladdningar av bilder och videor som har tagits av kameraappen. Dina filer kan fortfarande sparas och nås från OneDrive för företag molnlagring. De OneDrive HoloLens och HoloLens arbetar med problemet.

### <a name="workarounds"></a>Provisoriska lösningar

Krav: Kunder kan använda Microsoft Edge och enhetens operativsystem uppdateras till en Windows Holographic, 21H1-version eller nyare.
...
Vissa användare kan uppleva Microsoft Store fungerar inte som förväntat och ser felkoden 0x80131500. Det här är ett problem som orsakas av att regionen på HoloLens inte är tillgänglig i Microsoft Store på HoloLens. Om du stöter på 0x80131500 kan du lösa problemet genom att:
...
Här kan [du se länder att köpa HoloLens 2.](hololens2-purchase.md)

## <a name="microsoft-edge-fails-to-start-the-microphone"></a>Microsoft Edge kan inte starta mikrofonen

När användare som använder Microsoft Edge mikrofonen inte kan starta, vilket innebär att de inte kan interagera med Edge i HoloLens. Det här kända problemet är relaterat till versionen av Microsoft Edge-appen. Omstrecka inte enheten till en tidigare version eftersom detta inte löser problemet.
...
Den aktuella korrigeringen finns i version 96, som är tillgänglig för användare som har registrerats i Microsoft Edge Insiders. Detta skiljer sig från att registrera din enhet som en Windows Insider. Läs de här anvisningarna om [du vill ha mer information om hur du registrerar dig i Edges insiderprogram.](hololens-new-edge.md#microsoft-edge-insider-channels)
...
- Om enhetens PIN-kod inte kan sparas och andra autentiseringsmetoder inte är tillgängliga kan en användare använda [manuellt omstrecksläge](hololens-recovery.md#manual-flashing-mode-procedure).
...
Det finns ett problem under OOBE, där när användaren har valt ett arbets- eller skolkonto och anger sitt lösenord och försöker växla till specialtecken på tangentbordet genom att trycka på knappen &123 ändras inte till specialtecken. Det här är **ett känt problem.**
...
I tidigare versioner Windows Holographic blir resultatet en HTTP-felsida när du försöker ladda ned en låst fil. I Windows Holographic version 21H1-uppdateringen, som försöker ladda ned en låst fil, resulterar det i att inget synligt händer– filen laddas inte ned och det uppstår inga fel.
...
- Omstrecka enheten
    ...
    1. Försätt [HoloLens 2 i flashläge manuellt](hololens-recovery.md) genom att stänga av helt utan att ansluta. Håll sedan volymen uppåt och tryck på strömknappen.
...
- Funktionen Förhandsgranskning i Mixed Reality kan ha flera sekunders svarstid.
...
Du kan koppla ihop Bluetooth HID- och GATT-enheter med HoloLens. Du kan dock behöva installera motsvarande tillhörande appar från Microsoft Store för att faktiskt använda enheterna.
