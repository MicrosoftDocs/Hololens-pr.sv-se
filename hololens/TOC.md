...
#### [Ny Microsoft Edge](hololens-new-edge.md)
### Hantera program
...
### [HoloLens 2 vanliga frågor och svar om rensning](hololens2-maintenance.md)

# Distribuera HoloLens 2
## [Vanliga distributionsscenarier](hololens-requirements.md)
## [Planera HoloLens 2-distribution](hololens-core-components.md)
## Distributionsguider
...
#### [Externa klienter](hololens2-deployment-guide.md)
...
### [HoloLens 2 Sekretess och dataskydd](hololens2-privacy.md)
## Enhetsregistrering
...
# Felsökning
## [Enhet](hololens-troubleshooting.md)
## [Hologram och interaktioner](hololens-faq.md)
...
## [Läs mer om Microsoft Mesh (förhandsversion)](/mesh/overview)
## HoloLens (första generationen)
### Första användning
#### [Om HoloLens (första generationen)](hololens1-hardware.md)
#### [HoloLens (1:a generationen) – passning och bekvämlighet](hololens1-fit-comfort-faq.md)
