...
✔️ Om du behöver göra din organisations appar tillgängliga i företagsbutiken via Microsoft Store, men bara vill tillåta åtkomst till din organisations appar och inte hela butiken, anger du den [här principen](#use-only-private-store-apps-for-microsoft-store). <br>
...
> [!NOTE]
> För att kunna registrera din enhet i Insider-byggen måste du aktivera valfri telemetri. Om du inte redan har gjort detta öppnar du Inställningar appen och väljer Sekretessdiagnostik & feedback och  ->   väljer **sedan Valfria diagnostikdata.**
