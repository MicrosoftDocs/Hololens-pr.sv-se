...
Windows insider flyttas nu till Kanaler. Den **snabba** ringen blir Dev  **Channel,** den långsamma ringen blir **den Betakanal** och **förhandsgranskningsringen** blir kanalen för **förhandsversionen.** Så här ser mappningen ut:
