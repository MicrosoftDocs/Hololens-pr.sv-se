...
Olika typer av ljus i ett utrymme kan också påverka spårning. Glödlampan pulserar med ac-elektriciteten som passerar genom den – om AC-frekvensen är 50 Hz, så pulserar lampan vid 50 Hz. För en människa märks inte pulserandet. Men HoloLens 30 kamera med 30 bilder ser dessa ändringar – vissa bildrutor är väl upplysta, vissa kommer att vara dåligt upplysta och vissa blir överuttända när kameran försöker kompensera för ljuspulser.  

I USA är standarden för elektricitetsfrekvens 60 Hz, så glödlampans pulser räknas med HoloLens-bildfrekvens – 60 Hz-pulser justeras med HoloLens" 30 FP-bildfrekvens. Många länder har dock en AC-frekvensstandard på 50 Hz, vilket innebär att vissa HoloLens bildrutor tas under pulserna och andra inte gör det. I synnerhet har belysning i Europa varit känd för att orsaka problem.  
...
Starkt reflektiva ytor ser troligen olika ut beroende på vinkeln, vilket påverkar spårningen. Tänk på en helt ny bil – när du flyttar runt den reflekteras lampan och du ser olika objekt på ytan när du flyttar. För spåraren representerar de olika objekten som visas på ytan en föränderlig miljö och enheten förlorar spårning.
...
När du anger ett nytt blanksteg (eller läser in ett befintligt) visas en nätgrafik som sprids över utrymmet. Det innebär att enheten mappar din miljö. En HoloLens lär sig ett utrymme över tid, men det finns tips och trick för att mappa utrymmen.

## <a name="environment-management"></a>Miljöhantering

Det finns två inställningar som gör att användarna kan "rensa" hologram och HoloLens "glömmer" ett blanksteg. De finns Hologram miljöer i inställningsappen, och den andra inställningen visas också under **Sekretess** i **inställningsappen.**  

1. **Ta bort hologram i närheten.** När du väljer den här HoloLens raderar alla fästna hologram och alla lagrade kartdata för det "aktuella utrymmet" där enheten finns. Ett nytt kartavsnitt skulle skapas och lagras i databasen för den platsen när hologram återigen placeras i samma utrymme.

1. **Ta bort alla hologram.** Genom att välja den här HoloLens raderar alla kartdata och fästa hologram i hela blankstegsdatabaserna. Inga hologram kommer att återidentifieras och eventuella hologram måste nyligen placeras för att lagra kartavsnitt i databasen igen.
...
För att [dina hologram](/windows/mixed-reality/hologram) ska se klara, tydliga och stabila ut måste HoloLens kalibreras bara för dig. När du först HoloLens konfigurera din dator vägleds du genom den här processen. Senare, om hologram inte ser bra ut eller om du får många fel, kan du göra justeringar.
...
Gå till appen Kalibrering genom att gå **Inställningar**  >    >  **SystemVerktyg**. Välj **Öppna kalibrering** och följ instruktionerna.
