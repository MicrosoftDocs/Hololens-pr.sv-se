...
Fullständig [information om enhetsdeladd kan läsas här](hololens-recovery.md#charge-the-device) om mer information behövs. 
...
Overheadförseningar krävs inte, men det kan göra att HoloLens 2 blir mer bekväm under långa perioder av användning.
...
> [!NOTE]
> Om du vill starta HoloLens 2 för första gången, efter att du har packat upp, trycker du på och håller ned strömknappen i minst 4 sekunder för att aktivera den. Nästa gång du startar HoloLens 2 startar den efter en kort tryckning på strömknappen.
...
| Tvinga Hololens att starta om om det inte svarar | Tryck och håll ned i 10 sekunder. | Alla fem lamporna tänds och tonas sedan bort en i taget. När lamporna har släckt. |

## <a name="hololens-behavior-reference"></a>HoloLens-beteendereferens

Är du osäker på vad indikatorn på din HoloLens betyder? Vill du veta hur HoloLens ska bete sig vid debitering?  Här är lite hjälp!
...
| Tre helljus, en ljuslyssna in och ut | Mellan 80 % och 61 % |
...
| - | - | - |
| Du trycker på strömknappen. | En lampa är fem gånger och stängs sedan av. | HoloLens-batteriet är extremt lågt. Debitera din HoloLens. |
...
Använd din HoloLens i ett säkert utrymme, utan hinder och utlösta hinder. Använd den inte när du behöver ett tydligt synfält eller inte kan ge dig fullständig uppmärksamhet, till exempel när du använder ett fordon eller utför andra potentiellt farliga aktiviteter.
...
> [Starta och konfigurera hololens 2](hololens2-start.md)
